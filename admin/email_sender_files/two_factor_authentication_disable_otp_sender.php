...
// Email Send Code
$subject = "Account Disable Two Factor Authenticaion Notification";
$body = "Your Disable Two Factor Authenticaion OTP is <b>" . $user_otp;
...
function smtp_mailer($to, $subject, $msg)
{
    ...
    if (!$mail->Send()) {
        ...
        return "<script>window.location.href='http://localhost/LMS/admin/two_factor_authentication_disable_otp_auth.php'</script>";
    }
}
