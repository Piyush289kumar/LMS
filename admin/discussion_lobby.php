  ...
  if (isset($_POST['save'])) {
    try {
      ...
      if (mysqli_query($conn, $sql_insert_chat)) {
        echo "<script>window.location.href='$hostname/admin/discussion_lobby.php?receiver_id=$receiver_id'</script>";
      } else {
    ...
    <section class="section profile">
      <div class="row">
        ...
        <div class="col-xl-4 overflow-y-auto" style='height:75vh;'>
          ...
          ?>
              <!-- Card Element -->
              <a href="discussion_lobby.php?receiver_id=<?php echo $row_sql_fetch_all_user['receiver_id']; ?>" class='text-dark'>
