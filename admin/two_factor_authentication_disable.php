  ...
  if (mysqli_num_rows($result_sql_user_pass_cheack) > 0) {
    while ($row = mysqli_fetch_assoc($result_sql_user_pass_cheack)) {
      ...
      if (mysqli_query($conn, $sql_otp_create)) {
        echo "<script>window.location.href='$hostname/admin/email_sender_files/two_factor_authentication_disable_otp_sender.php'</script>";
      } else {
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter your email & password to disable Two-Factor Authentication</p>
                  </div>
