...
if (isset($_POST['verify'])) {
  ...
  if (mysqli_num_rows($otp_query_response) > 0) {
    ...
    $sql_otp_create = "UPDATE user_data SET tfa ='No' WHERE username = '{$username}' AND email = '{$email}'";
    if (mysqli_query($conn, $sql_otp_create)) {
?>
      <script>
        alert('Two Factor Authenticaion is Disable successfully.')
      </script>
<?php
      echo "<script>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Disable - Two Factor Authentication</h5>
