          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Enrollment</h5>
                  ...
                  <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" class="row g-3 needs-validation" novalidate autocomplete="off">
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" name="email" class="form-control" id="email" value="<?php echo $username ?>" required disabled>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" name="email" class="form-control" id="email" value="<?php echo $email ?>" required disabled>
